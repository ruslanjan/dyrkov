...
************************************************************************/
    ...
    {
        /// <summary>
        /// Example MonoMemory Interface. Replace with your own.
        /// </summary>
        internal static class MonoMemory
        {
            /// <summary>
            ...
            {
                return Memory.ReadBuffer(va, cb).ToArray();
            }
        ...
        internal static class Mono
        {
            ...
            public static ulong FindClass(string assembly_name, string class_name)
            {
                ...
                var deref = MonoMemory.ReadValue<ulong>(monoClass + 0x0); // Deref at 0x0
                if (deref == 0x0)
            ...
            public static ulong GetStaticFieldDataOfClass(string assembly_name, string class_name)
            {
                ...
                var deref = MonoMemory.ReadValue<ulong>(staticFieldData + 0x0); // Deref at 0x0
                if (deref == 0x0)
                    throw new Exception("NULL " + nameof(deref));
                return deref;
            }
            ...
            private static class Monolib
            {
                ...
                public static string read_widechar(ulong addr, int size)
                {
                    try
                    {
                        var buffer = MonoMemory.ReadBuffer(addr, size);
                ...
                {
                    var mono_module = MonoMemory.GetMonoModule();
                    if (mono_module == 0x0)
                        return default;
                    return new mono_root_domain_t(MonoMemory.ReadValue<ulong>(mono_module + 0x499c78));
                }
                ...
                public static bool init_functions()
                {
                    ...
                    if (jitted_table == 0x0)
                        return false;
                    int iCount = MonoMemory.ReadValue<int>(jitted_table + 0x8);
                    if (iCount > 10000)
                    {
                    ...
                    {
                        var entry = MonoMemory.ReadValue<ulong>(jitted_table + 0x10 + (uint)i * 0x8);
                        if (entry == 0x0)
                            continue;
                        int jCount = MonoMemory.ReadValue<int>(entry + 0x4);
                        if (jCount > 1000)
                        {
                        ...
                        {
                            var function = MonoMemory.ReadValue<ulong>(entry + 0x18 + (uint)j * 0x8);
                            if (function == 0x0)
                                continue;

                            var mono_ptr = MonoMemory.ReadValue<ulong>(function + 0x0);
                            var jitted_ptr = MonoMemory.ReadValue<ulong>(function + 0x10);
                ...
                public static mono_assembly_t domain_assembly_open(mono_root_domain_t domain, string name)
                {
                    ...
                    while (true)
                    {
                        ...
                        var data_name = read_widechar(MonoMemory.ReadValue<ulong>(data + 0x10), 128);
                        if (data_name == name)
                            break;
            ...
            public readonly struct glist_t
            {
                ...
                public readonly ulong data() => MonoMemory.ReadValue<ulong>(this + 0x0);
                public readonly ulong next() => MonoMemory.ReadValue<ulong>(this + 0x8);
            }
            ...
            public readonly struct mono_root_domain_t
            {
                ...
                public readonly glist_t domain_assemblies() => new glist_t(MonoMemory.ReadValue<ulong>(this + 0xC8));
                public readonly int domain_id() => MonoMemory.ReadValue<int>(this + 0xBC);
                public readonly ulong jitted_function_table() => MonoMemory.ReadValue<ulong>(this + 0x148);
            }
            ...
            public readonly struct mono_table_info_t
            {
                ...
                public readonly int get_rows() => MonoMemory.ReadValue<int>(this + 0x8) & 0xFFFFFF;
            }
            ...
            public readonly struct mono_method_t
            {
                ...
                {
                    var address = MonoMemory.ReadValue<ulong>(this + 0x18);
            ...
            public readonly struct mono_class_field_t
            {
                ...
                public readonly string name()
                {
                    var address = MonoMemory.ReadValue<ulong>(this + 0x8);
                    string name = Monolib.read_widechar(address, 128);
                ...
                {
                    return MonoMemory.ReadValue<int>(this + 0x18);
                }
            }
            ...
            public readonly struct mono_class_runtime_info_t
            {
                ...
                public readonly int max_domain() => MonoMemory.ReadValue<int>(this + 0x0);
            }
            ...
            public readonly struct mono_vtable_t
            {
                ...
                public readonly byte flags() => MonoMemory.ReadValue<byte>(this + 0x30);

                public readonly ulong get_static_field_data()
                {
                    if ((this.flags() & 4) != 0)
                        return MonoMemory.ReadValue<ulong>(this + 0x40 + 8 * (uint)MonoMemory.ReadValue<int>(MonoMemory.ReadValue<ulong>(this + 0x0) + 0x5C));
                    return 0x0;
                }
            }
            ...
            public readonly struct mono_class_t
            {
                ...
                public readonly int num_fields() => MonoMemory.ReadValue<int>(this + 0x100);
                public readonly mono_class_runtime_info_t runtime_info() => new mono_class_runtime_info_t(MonoMemory.ReadValue<ulong>(this + 0xD0));

                public readonly string name()
                {
                    var address = MonoMemory.ReadValue<ulong>(this + 0x48);
                    string name = Monolib.read_widechar(address, 128);
                ...
                {
                    var address = MonoMemory.ReadValue<ulong>(this + 0x50);
                    string name = Monolib.read_widechar(address, 128);
                ...
                {
                    var v2 = (MonoMemory.ReadValue<int>(this + 0x2A) & 7) - 1;
                    switch (v2)
                    {
                        case 0:
                        case 1:
                            return MonoMemory.ReadValue<int>(this + 0xFC);
                        ...
                        case 4:
                            return MonoMemory.ReadValue<int>(this + 0xF0);
                ...
                public readonly mono_method_t get_method(int i) =>
                    new mono_method_t(MonoMemory.ReadValue<ulong>(MonoMemory.ReadValue<ulong>(this + 0xA0) + 0x8 * (uint)i));


                public readonly mono_class_field_t get_field(int i)
                {
                    var fieldsPtr = MonoMemory.ReadValue<ulong>(this + 0x98);
                ...
                public readonly mono_vtable_t get_vtable(mono_root_domain_t domain)
                {
                    ...
                    return new mono_vtable_t(MonoMemory.ReadValue<ulong>(runtime_info + 8 * (uint)domain_id + 8));
                }
            ...
            public readonly struct mono_hash_table_t
            {
                ...
                public readonly int size() => MonoMemory.ReadValue<int>(this + 0x18);
                public readonly ulong data() => MonoMemory.ReadValue<ulong>(this + 0x20);
                public readonly ulong next_value() => MonoMemory.ReadValue<ulong>(this + 0x108);
                public readonly uint key_extract() => MonoMemory.ReadValue<uint>(this + 0x58);

                public readonly ulong lookup(ulong key)
                {
                    var v4 = new mono_hash_table_t(MonoMemory.ReadValue<ulong>(data() + 0x8 * (ulong)((uint)key % this.size())));
                    if (v4 == 0x0)
                        return default;
            ...
            public readonly struct mono_image_t
            {
                ...
                public readonly int flags() => MonoMemory.ReadValue<int>(this + 0x1C);
            ...
            public readonly struct mono_assembly_t
            {
                ...
                public readonly mono_image_t mono_image()
                    => new mono_image_t(MonoMemory.ReadValue<ulong>(this + 0x60));
            }
        }
    }
}
