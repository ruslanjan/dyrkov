    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            try
            {
                if (_singleton)
                {
                    RuntimeHelpers.RunClassConstructor(typeof(DyrkovMarketManager).TypeHandle); // invoke static constructor
            ...
            {
                MessageBox.Show(ex.ToString(), "Dyrkov Pidar", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        #endregion
